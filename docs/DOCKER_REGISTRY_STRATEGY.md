...
```
lahm-backend-amd64:v1.0.0  (只包含 AMD64)
lahm-backend-arm64:v1.0.0  (只包含 ARM64)
```
...
| 架构 | 后端镜像 | 前端镜像 |
|------|---------|---------|
| **AMD64** | `hsliuping/lahm-backend-amd64` | `hsliuping/lahm-frontend-amd64` |
| **ARM64** | `hsliuping/lahm-backend-arm64` | `hsliuping/lahm-frontend-arm64` |

### 镜像标签

| 标签 | 说明 | 示例 |
|------|------|------|
| `latest` | 最新稳定版 | `hsliuping/lahm-backend-amd64:latest` |
| `v{version}` | 指定版本 | `hsliuping/lahm-backend-amd64:v1.0.0-preview` |
| `v{version}-rc{n}` | 候选版本 | `hsliuping/lahm-backend-amd64:v1.0.0-rc1` |
| `dev` | 开发版本 | `hsliuping/lahm-backend-amd64:dev` |
...
# 2. 推送到 Docker Hub
# 自动推送到:
#   - hsliuping/lahm-backend-amd64:v1.0.1
#   - hsliuping/lahm-backend-amd64:latest
#   - hsliuping/lahm-frontend-amd64:v1.0.1
#   - hsliuping/lahm-frontend-amd64:latest
...
# 2. 推送到 Docker Hub
# 自动推送到:
#   - hsliuping/lahm-backend-arm64:v1.0.1
#   - hsliuping/lahm-backend-arm64:latest
#   - hsliuping/lahm-frontend-arm64:v1.0.1
#   - hsliuping/lahm-frontend-arm64:latest
```
...
# 或指定版本
docker pull hsliuping/lahm-backend-amd64:v1.0.0-preview
```
...
# 或指定版本
docker pull hsliuping/lahm-backend-arm64:v1.0.0-preview
```
