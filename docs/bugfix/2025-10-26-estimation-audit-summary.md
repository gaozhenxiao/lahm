...
**问题描述**:
- **位置**: `lahm/dataflows/optimized_china_data.py:1392`
...
**问题描述**:
- **位置**: `lahm/dataflows/optimized_china_data.py:1578-1637`
...
**位置**: 
- `lahm/llm_adapters/deepseek_adapter.py:164-197`
- `lahm/llm_adapters/openai_compatible_base.py:259-261`
- `lahm/agents/managers/research_manager.py:77,92`
- `lahm/agents/managers/risk_manager.py:58,66,101`
...
- `lahm/config/config_manager.py:742`
...
**位置**: `lahm/dataflows/providers/china/baostock.py:537`
```python
...
**位置**: 
- `lahm/dataflows/optimized_china_data.py:472`
- `lahm/dataflows/optimized_china_data.py:530`
- `lahm/dataflows/optimized_china_data.py:637`
...
**位置**: `lahm/dataflows/optimized_china_data.py:437-438`
```python
