...
柳暗花明 采用多智能体协作架构，模拟真实金融机构的团队协作模式。每个智能体都有明确的职责分工，通过状态共享和消息传递实现协作决策。本文档基于实际代码结构，详细描述了智能体的架构设计和实现细节。

## 🏗️ 智能体层次结构

### 架构层次

柳暗花明 采用5层智能体架构，每层专注于特定的功能领域：
...
基于实际代码 `lahm/agents/utils/agent_states.py`，系统使用 `AgentState` 类管理所有智能体的共享状态：
...
**文件位置**: `lahm/agents/analysts/fundamentals_analyst.py`
...
**文件位置**: `lahm/agents/analysts/market_analyst.py`
...
**文件位置**: `lahm/agents/analysts/news_analyst.py`
...
**文件位置**: `lahm/agents/analysts/social_media_analyst.py`
...
**文件位置**: `lahm/agents/analysts/china_market_analyst.py`
...
**文件位置**: `lahm/agents/researchers/bull_researcher.py`
...
**文件位置**: `lahm/agents/researchers/bear_researcher.py`
...
**文件位置**: `lahm/agents/trader/trader.py`
...
**文件位置**: `lahm/agents/risk_mgmt/conservative_debator.py`
...
**文件位置**: `lahm/agents/risk_mgmt/neutral_debator.py`
...
**文件位置**: `lahm/agents/risk_mgmt/aggresive_debator.py`
...
**文件位置**: `lahm/agents/managers/research_manager.py`
...
**文件位置**: `lahm/agents/managers/risk_manager.py`
...
**文件位置**: `lahm/agents/utils/google_tool_handler.py`
...
柳暗花明 智能体架构通过清晰的分层设计、统一的状态管理和灵活的扩展机制，为复杂的金融决策流程提供了强大而可靠的技术基础。