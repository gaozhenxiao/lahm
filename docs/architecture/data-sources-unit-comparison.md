...
2. **`lahm/dataflows/providers/china/tushare.py`** (第 1175-1178 行)
...
1. **`lahm/dataflows/providers/china/akshare.py`** (第 712-751 行)
   - AKShare 历史数据列名标准化

2. **`lahm/dataflows/providers/china/tushare.py`** (第 1261-1278 行)
   - Tushare 历史数据标准化
