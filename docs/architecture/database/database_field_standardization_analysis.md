...
| **StockBasicInfo (lahm)** | `symbol` | 6位股票代码 | "000001" |
| **StockDailyQuote (lahm)** | `symbol` | 6位股票代码 | "000001" |
...
| **StockBasicInfo (lahm)** | `exchange_symbol` | 交易所完整代码 | "000001.SZ" |
...
- [ ] `lahm/models/stock_data_models.py` - 已使用symbol ✅
