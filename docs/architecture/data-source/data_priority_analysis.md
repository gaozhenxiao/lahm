...
### 1. **DataSourceManager** (lahm/dataflows/data_source_manager.py)
...
### 2. **OptimizedChinaDataProvider** (lahm/dataflows/optimized_china_data.py)
...
**文件**: `lahm/dataflows/cache/mongodb_cache_adapter.py` 第 126 行
...
**文件**: `lahm/dataflows/optimized_china_data.py` 第 809-820 行
...
**文件**: `lahm/dataflows/optimized_china_data.py` 第 691-709 行
