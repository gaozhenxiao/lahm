...
**修改位置：** `lahm/dataflows/data_source_manager.py` 第 462-475 行
...
2. **修改文件：**
   ...
   - `lahm/dataflows/providers/us/optimized.py` - 美股数据提供器
   - `lahm/dataflows/providers/china/tushare.py` - Tushare 提供器
