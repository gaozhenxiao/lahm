...
- 工具函数: `lahm/dataflows/normalization.py` ✅ 已创建
...
**新模型**: `lahm/models/multi_market_models.py` ✅ 已创建
...
- [ ] 实现行业映射工具 (`lahm/dataflows/industry_mapper.py`)
- [ ] 批量更新现有数据的行业分类
- [ ] API支持按行业筛选（跨市场）
