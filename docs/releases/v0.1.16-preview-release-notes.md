...
## 🎯 概览
v1.0.0-preview 标志着项目从“单一 Streamlit 应用 + lahm 库”演进为“后端 API + 现代前端 + 现有 Streamlit 共存”的多应用架构：
...
### 3) 核心库增强
- lahm/ 下 dataflows、tools/analysis/indicators、graph/trading_graph 等模块增强
