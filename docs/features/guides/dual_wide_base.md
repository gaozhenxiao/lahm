...
来源：`data/factors/dual_wide_base_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only dual_wide_base --limit 40
python scripts/run_new_factors.py --only dual_wide_base --limit 0
```

产物：`data/factors/dual_wide_base_*`
