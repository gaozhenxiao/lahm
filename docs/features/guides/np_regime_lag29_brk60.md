# 净利率体制切换(滞后29突破60)（np_regime_lag29_brk60）
...
来源：`data/factors/np_regime_lag29_brk60_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only np_regime_lag29_brk60 --limit 40
python scripts/run_new_factors.py --only np_regime_lag29_brk60 --limit 0
```

产物：`data/factors/np_regime_lag29_brk60_*`
