# 双改善横盘突破（dual_improve_base_break）
...
来源：`data/factors/dual_improve_base_break_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only dual_improve_base_break --limit 40
python scripts/run_new_factors.py --only dual_improve_base_break --limit 0
```

产物：`data/factors/dual_improve_base_break_*`
