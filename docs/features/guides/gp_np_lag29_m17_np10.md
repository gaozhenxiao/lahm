# 毛净双扩张(滞后29毛利0.17净利0.10)（gp_np_lag29_m17_np10）
...
来源：`data/factors/gp_np_lag29_m17_np10_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only gp_np_lag29_m17_np10 --limit 40
python scripts/run_new_factors.py --only gp_np_lag29_m17_np10 --limit 0
```

产物：`data/factors/gp_np_lag29_m17_np10_*`
