# 双同比高增(滞后29增15%)（twin_yoy_lag29_g15）
...
来源：`data/factors/twin_yoy_lag29_g15_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only twin_yoy_lag29_g15 --limit 40
python scripts/run_new_factors.py --only twin_yoy_lag29_g15 --limit 0
```

产物：`data/factors/twin_yoy_lag29_g15_*`
