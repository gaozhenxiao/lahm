# 毛净利差收敛突破(lag28持有52)（catchup_break_lag28_hold52）
...
```bash
python scripts/run_new_factors.py --only catchup_break_lag28_hold52 --limit 40
python scripts/run_new_factors.py --only catchup_break_lag28_hold52 --limit 0
```

产物：`data/factors/catchup_break_lag28_hold52_*`
