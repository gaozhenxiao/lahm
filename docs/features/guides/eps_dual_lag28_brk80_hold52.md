# EPS双确认(突破80持有52)（eps_dual_lag28_brk80_hold52）
...
```bash
python scripts/run_new_factors.py --only eps_dual_lag28_brk80_hold52 --limit 40
python scripts/run_new_factors.py --only eps_dual_lag28_brk80_hold52 --limit 0
```

产物：`data/factors/eps_dual_lag28_brk80_hold52_*`
