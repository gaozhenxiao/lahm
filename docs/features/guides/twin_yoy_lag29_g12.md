# 双同比高增(滞后29增12%)（twin_yoy_lag29_g12）
...
来源：`data/factors/twin_yoy_lag29_g12_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only twin_yoy_lag29_g12 --limit 40
python scripts/run_new_factors.py --only twin_yoy_lag29_g12 --limit 0
```

产物：`data/factors/twin_yoy_lag29_g12_*`
