# 毛净双扩张(滞后30毛利0.17净利改善0.005)（gp_np_lag30_m17_nimp005）
...
```bash
python scripts/run_new_factors.py --only gp_np_lag30_m17_nimp005 --limit 40
python scripts/run_new_factors.py --only gp_np_lag30_m17_nimp005 --limit 0
```

产物：`data/factors/gp_np_lag30_m17_nimp005_*`
