...
```bash
python scripts/run_new_factors.py --only dual_mid_hold52 --limit 40
python scripts/run_new_factors.py --only dual_mid_hold52 --limit 0
```

产物：`data/factors/dual_mid_hold52_*`
