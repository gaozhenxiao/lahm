# ROE扩张×净利率0.10(lag28持有51)（roe_lag28_np10）
...
来源：`data/factors/roe_lag28_np10_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only roe_lag28_np10 --limit 40
python scripts/run_new_factors.py --only roe_lag28_np10 --limit 0
```

产物：`data/factors/roe_lag28_np10_*`
