# 双改善长横盘突破（dual_improve_long_base）
...
```bash
python scripts/run_new_factors.py --only dual_improve_long_base --limit 40
python scripts/run_new_factors.py --only dual_improve_long_base --limit 0
```

产物：`data/factors/dual_improve_long_base_*`
