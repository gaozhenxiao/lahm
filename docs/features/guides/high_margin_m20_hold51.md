# 高净利率门槛0.20(持有51)（high_margin_m20_hold51）
...
```bash
python scripts/run_new_factors.py --only high_margin_m20_hold51 --limit 40
python scripts/run_new_factors.py --only high_margin_m20_hold51 --limit 0
```

产物：`data/factors/high_margin_m20_hold51_*`
