...
来源：`data/factors/dual_mid_amp22_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only dual_mid_amp22 --limit 40
python scripts/run_new_factors.py --only dual_mid_amp22 --limit 0
```

产物：`data/factors/dual_mid_amp22_*`
