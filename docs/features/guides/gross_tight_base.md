...
```bash
python scripts/run_new_factors.py --only gross_tight_base --limit 40
python scripts/run_new_factors.py --only gross_tight_base --limit 0
```

产物：`data/factors/gross_tight_base_*`
