...
来源：`data/factors/dual_break_hold50_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only dual_break_hold50 --limit 40
python scripts/run_new_factors.py --only dual_break_hold50 --limit 0
```

产物：`data/factors/dual_break_hold50_*`
