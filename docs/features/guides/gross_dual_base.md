...
```bash
python scripts/run_new_factors.py --only gross_dual_base --limit 40
python scripts/run_new_factors.py --only gross_dual_base --limit 0
```

产物：`data/factors/gross_dual_base_*`
