# 轻资产高增突破(滞后29增10%)（asset_light_lag29_g10）
...
来源：`data/factors/asset_light_lag29_g10_trade_history.csv`
...
```bash
python scripts/run_new_factors.py --only asset_light_lag29_g10 --limit 40
python scripts/run_new_factors.py --only asset_light_lag29_g10 --limit 0
```

产物：`data/factors/asset_light_lag29_g10_*`
