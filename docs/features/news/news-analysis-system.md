...
本文档详细介绍了Lahm系统中的新闻分析工具链架构、提示词设计和实现机制。
...
**位置**: `lahm/agents/analysts/news_analyst.py`
...
**位置**: `lahm/dataflows/realtime_news_utils.py`
...
这个新闻分析工具链和提示词系统为Lahm提供了强大的新闻分析能力，能够实时获取、处理和分析市场新闻，为投资决策提供重要参考。