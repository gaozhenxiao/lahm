...
**创建新文件**：
```bash
cp lahm/dataflows/enhanced_data_adapter.py \
   lahm/dataflows/cache/mongodb_cache_adapter.py
```
...
**创建目录和文件**：
```bash
mkdir -p lahm/dataflows/providers/examples
cp lahm/dataflows/example_sdk_provider.py \
   lahm/dataflows/providers/examples/example_sdk.py
```
...
from lahm.config.runtime_settings import get_setting
...
```python
# 旧
from lahm.dataflows.enhanced_data_adapter import get_enhanced_data_adapter

# 新
from lahm.dataflows.cache.mongodb_cache_adapter import get_mongodb_cache_adapter
```
...
```python
# 旧
from lahm.dataflows.example_sdk_provider import ExampleSDKProvider
from lahm.config.runtime_settings import get_setting

# 新
import os
from lahm.dataflows.providers.examples.example_sdk import ExampleSDKProvider
```

### 4. 删除旧文件

```bash
git rm lahm/dataflows/enhanced_data_adapter.py
git rm lahm/dataflows/example_sdk_provider.py
```
...
rename lahm/dataflows/{enhanced_data_adapter.py => cache/mongodb_cache_adapter.py} (92%)
create mode 100644 lahm/dataflows/providers/examples/__init__.py
rename lahm/dataflows/{example_sdk_provider.py => providers/examples/example_sdk.py} (97%)
```
...
**推荐**：
```python
from lahm.dataflows.cache import get_mongodb_cache_adapter
...
**向后兼容**：
```python
from lahm.dataflows.cache.mongodb_cache_adapter import get_enhanced_data_adapter
...
```python
from lahm.dataflows.providers.base_provider import BaseStockDataProvider
