...
### 1. 删除的文件
- ✅ `lahm/dataflows/providers/china/tdx.py` - TDX 数据提供器

### 2. 修改的文件

#### `lahm/dataflows/providers/china/__init__.py`
**移除内容**：
```python
# 导入通达信提供器
try:
...
### 受影响的组件
1. ✅ `lahm/dataflows/providers/china/tdx.py` - 已删除
2. ✅ `lahm/dataflows/providers/china/__init__.py` - 已更新
3. ✅ `lahm/dataflows/data_source_manager.py` - 已移除 TDX 支持
...
```python
# ❌ 不再支持
from lahm.dataflows.providers.china.tdx import TongDaXinDataProvider
...
### 移除的内容
- ❌ `lahm/dataflows/providers/china/tdx.py` 文件
