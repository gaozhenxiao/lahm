...
**查询逻辑**:
```python
# 文件: lahm/dataflows/cache/mongodb_cache_adapter.py (第87行)
...
```bash
# 连接 MongoDB
mongo mongodb://admin:lahm123@localhost:27017/lahm
...
- `lahm/dataflows/cache/mongodb_cache_adapter.py` (第70-114行) - MongoDB缓存适配器
