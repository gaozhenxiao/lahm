# 柳暗花明 v1.0.0-preview 源码版安装手册

## 概述

本手册指导您从源码安装 柳暗花明 v1.0.0-preview 版本，该版本采用前后端分离架构：
...
MONGODB_URL=mongodb://admin:lahm123@localhost:27017/lahm?authSource=admin
REDIS_URL=redis://:lahm123@localhost:6379/0
...
```bash
# 连接MongoDB（使用管理员账户）
mongosh mongodb://admin:lahm123@localhost:27017/admin
...
```bash
mongosh mongodb://admin:lahm123@localhost:27017/lahm?authSource=admin
