...
> 📦 柳暗花明 v1.0.0-preview Docker配置文件说明

## 📋 概述

柳暗花明 v1.0.0-preview采用**前后端分离架构**，使用独立的Docker镜像分别构建和部署前端和后端服务。
...
| 镜像 | 大小（预估） | 说明 |
|------|-------------|------|
| **lahm-backend** | ~800MB | Python 3.10 + 依赖 |
| **lahm-frontend** | ~25MB | Nginx + 静态文件 |
| **总计** | ~825MB | 前后端镜像总和 |
