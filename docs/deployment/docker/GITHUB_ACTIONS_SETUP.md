...
5. 填写信息：
   - **Access Token Description**: `GitHub Actions - 柳暗花明`
...
1. 访问您的 GitHub 仓库：`https://github.com/YOUR_USERNAME/柳暗花明`
2. 点击 **Settings** 标签
...
**生成的镜像标签**：
- `your-username/lahm-backend:v1.0.1`
- `your-username/lahm-backend:latest`
- `your-username/lahm-backend:1.0`
- `your-username/lahm-frontend:v1.0.1`
- `your-username/lahm-frontend:latest`
- `your-username/lahm-frontend:1.0`
...
2. 登录您的账号
3. 查看仓库：
   - `your-username/lahm-backend`
   - `your-username/lahm-frontend`
4. 点击 **Tags** 标签，查看镜像版本
5. 点击具体的 tag，查看支持的架构：
   - ✅ `linux/amd64`
   - ✅ `linux/arm64`
...
```bash
# 验证后端镜像支持的架构
docker buildx imagetools inspect your-username/lahm-backend:latest

# 验证前端镜像支持的架构
docker buildx imagetools inspect your-username/lahm-frontend:latest
```

**预期输出**：
```
Name:      your-username/lahm-backend:latest
MediaType: application/vnd.docker.distribution.manifest.list.v2+json
Digest:    sha256:...

Manifests:
  Name:      your-username/lahm-backend:latest@sha256:...
...
docker pull your-username/lahm-backend:latest
docker pull your-username/lahm-frontend:latest

# 运行容器
docker run -d -p 8000:8000 your-username/lahm-backend:latest
```
...
services:
  backend:
    image: your-username/lahm-backend:latest
    # ...
  
  frontend:
    image: your-username/lahm-frontend:latest
    # ...
```
