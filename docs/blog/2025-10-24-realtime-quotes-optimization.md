...
创建 `lahm/core/data_source_codes.py` 统一管理：
...
docker build --platform linux/amd64 -t lahm:amd64 .
docker tag lahm:amd64 your-registry/lahm:amd64
docker push your-registry/lahm:amd64

# ARM64 架构（Apple Silicon/ARM服务器）
docker build --platform linux/arm64 -t lahm:arm64 .
docker tag lahm:arm64 your-registry/lahm:arm64
docker push your-registry/lahm:arm64
```
...
```bash
# AMD64 用户
docker pull your-registry/lahm:amd64

# ARM64 用户
docker pull your-registry/lahm:arm64
```
...
如有问题或建议，欢迎在 [GitHub Issues](https://github.com/hsliuping/lahm/issues) 中反馈。
