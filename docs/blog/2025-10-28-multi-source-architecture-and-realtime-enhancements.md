...
**示例错误**：
```
E11000 duplicate key error collection: lahm.stock_basic_info 
...
```python
# lahm/dataflows/realtime_metrics.py
...
```typescript
// 统一格式：Lahm_报告类型_股票代码_日期时间.pdf
const filename = `Lahm_${reportType}_${stockCode}_${timestamp}.pdf`

// 示例
// Lahm_分析报告_000001_20251028_143052.pdf
// Lahm_批量分析_20251028_143052.pdf
```
