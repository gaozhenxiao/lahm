...
```bash
# 1. 克隆预览分支
git clone -b feature/deepseek-v3-integration https://github.com/hsliuping/lahm.git
cd 柳暗花明
...
# 测试数据获取
python -c "
from lahm.dataflows.tdx_utils import get_china_stock_data
