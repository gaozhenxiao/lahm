...
- **GitHub Releases**: [https://github.com/hsliuping/lahm/releases](https://github.com/hsliuping/lahm/releases)
- **百度网盘**: 关注公众号 "柳暗花明" 获取下载链接
- **阿里云盘**: 关注公众号 "柳暗花明" 获取下载链接

文件名格式：`Lahm-Portable-v1.0.0-preview.zip` 或 `.7z`
...
2. **下载 docker-compose.yml**：
   ```bash
   # 从 GitHub 下载
   curl -O https://raw.githubusercontent.com/hsliuping/柳暗花明/main/docker-compose.yml
...
3. **创建 .env 文件**：
   ```bash
   # 复制示例配置
   curl -O https://raw.githubusercontent.com/hsliuping/柳暗花明/main/.env.example
   mv .env.example .env
...
1. **查看文档**: [docs/](../)
2. **GitHub Issues**: [https://github.com/hsliuping/lahm/issues](https://github.com/hsliuping/lahm/issues)
3. **微信公众号**: 柳暗花明
4. **QQ 群**: 关注公众号获取群号
