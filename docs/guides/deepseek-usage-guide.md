...
DeepSeek V3 是柳暗花明 v0.1.7新集成的成本优化AI模型，专为中文金融场景设计。相比GPT-4，DeepSeek V3在保持优秀分析质量的同时，成本降低90%以上，是进行股票分析的理想选择。
...
# 调试方法:
docker logs 柳暗花明-web | grep deepseek
```
...
# 批量分析多只股票
import asyncio
from lahm.llm_adapters.deepseek_adapter import ChatDeepSeek
