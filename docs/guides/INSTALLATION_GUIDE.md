...
- **Redis管理**: http://localhost:8081 (用户名/密码: admin/lahm123)
...
### 官方资源
- **项目主页**: https://github.com/hsliuping/lahm
- **文档中心**: https://www.lahm.cn/
- **问题反馈**: https://github.com/hsliuping/lahm/issues
