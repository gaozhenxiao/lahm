...
```bash
# 克隆项目到本地
git clone https://github.com/your-repo/柳暗花明.git
cd 柳暗花明
...
# 验证安装
python -c "import lahm; print('安装成功!')"
```
...
# MongoDB配置
MONGODB_URI=mongodb://localhost:27017/lahm
...
```bash
# 测试Python环境
python -c "import lahm; print('✅ 模块导入成功')"

# 测试依赖包
python -c "import streamlit, pandas, yfinance; print('✅ 依赖包正常')"

# 测试配置文件
python -c "from lahm.config import get_config; print('✅ 配置加载成功')"
```
...
### 1. 模块导入错误
```bash
# 问题: ModuleNotFoundError: No module named 'lahm'
# 解决方案:
pip install -e .
...
- **GitHub Issues**: [提交问题](https://github.com/your-repo/柳暗花明/issues)
- **文档**: [查看完整文档](../README.md)
