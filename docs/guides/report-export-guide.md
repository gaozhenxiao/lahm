...
柳暗花明 v0.1.7 引入了专业级的报告导出功能，支持将股票分析结果导出为Word、PDF、Markdown三种格式。本指南将详细介绍如何使用报告导出功能。
...
# 使用Python脚本批量导出
import os
from lahm.export.report_exporter import ReportExporter
...
# 每日导出重要股票分析
0 18 * * 1-5 cd /path/to/柳暗花明 && python scripts/daily_export.py
```
