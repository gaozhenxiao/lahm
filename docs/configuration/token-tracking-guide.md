...
本指南介绍如何配置和使用柳暗花明的Token使用统计和成本跟踪功能，包括v0.1.7新增的DeepSeek成本追踪和智能成本控制。

## 功能概述

柳暗花明提供了完整的Token使用统计和成本跟踪功能，包括：
...
```python
from lahm.llm_adapters.dashscope_adapter import ChatDashScope
...
```python
from lahm.config.config_manager import config_manager, PricingConfig
