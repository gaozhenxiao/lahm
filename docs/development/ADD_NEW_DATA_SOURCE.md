...
```
lahm/constants/data_sources.py
```
...
**文件**：`lahm/constants/data_sources.py`
...
**创建文件**：`lahm/dataflows/providers/{market}/your_new_source.py`

例如，如果是美股数据源：
```
lahm/dataflows/providers/us/your_new_source.py
```
...
```python
# lahm/dataflows/providers/us/polygon.py
...
1. **统一编码**：始终使用 `lahm/constants/data_sources.py` 中定义的编码
...
- [数据源编码定义](../../lahm/constants/data_sources.py)
