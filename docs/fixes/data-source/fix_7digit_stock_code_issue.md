...
```
2025-10-17 01:40:17 | lahm.dataflows.providers.china.akshare | WARNING  | ⚠️ 未找到0005661的行情数据
2025-10-17 01:40:17 | lahm.dataflows.providers.china.akshare | WARNING  | ⚠️ 未找到0005992的行情数据
2025-10-17 01:40:18 | lahm.dataflows.providers.china.akshare | WARNING  | ⚠️ 未找到0005997的行情数据
```
...
```bash
# Docker 环境
docker logs -f lahm-backend | grep "未找到"

# 本地环境
tail -f logs/lahm.log | grep "未找到"
```
...
```bash
# 连接 MongoDB
docker exec -it lahm-mongodb mongo lahm -u admin -p lahm123 --authenticationDatabase admin
