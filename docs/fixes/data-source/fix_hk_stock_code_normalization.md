...
```python
# lahm/utils/stock_validator.py:428-430
# 移除前导0，然后补齐到4位
...
```python
# lahm/dataflows/providers/hk/hk_stock.py:222-224 (旧代码)
# 如果是纯4-5位数字，添加.HK后缀
...
```python
# lahm/dataflows/providers/hk/hk_stock.py:207-236 (新代码)
...
**文件**：`lahm/dataflows/providers/hk/hk_stock.py`
...
2. **`lahm/agents/utils/agent_utils.py`**
   - `get_stock_market_data_unified()` - 统一市场数据工具
   - 港股数据获取

3. **`lahm/dataflows/providers/hk/improved_hk.py`**
