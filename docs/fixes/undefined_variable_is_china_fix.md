...
### 错误位置
**文件**: `lahm/agents/analysts/fundamentals_analyst.py`  
**行号**: 第135行

### 错误堆栈
```python
File "D:\code\柳暗花明\lahm\agents\analysts\fundamentals_analyst.py", line 135, in fundamentals_analyst_node
    if is_china:
NameError: name 'is_china' is not defined
```
...
# 或手动测试
python -c "
from lahm.agents.analysts.fundamentals_analyst import fundamentals_analyst_node
