...
### 修改的文件
1. `lahm/agents/analysts/fundamentals_analyst.py` - 基本面分析师
2. `lahm/agents/analysts/market_analyst.py` - 市场分析师
3. `lahm/agents/analysts/social_media_analyst.py` - 社交媒体分析师
4. `.env` - 环境变量配置（添加废弃说明）

### 未修改的文件
1. `lahm/agents/analysts/news_analyst.py` - 新闻分析师（已经使用统一工具）
2. `lahm/agents/utils/agent_utils.py` - 统一工具实现（无需修改）
3. `lahm/dataflows/interface.py` - 数据流接口（无需修改）
