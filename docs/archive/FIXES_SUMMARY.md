...
**修复文件：**
- `c:\Lahm\lahm\agents\utils\agent_utils.py`
...
**修复文件：**
- `c:\Lahm\lahm\agents\utils\google_tool_handler.py`
...
### 修改的文件
1. `lahm/default_config.py` - 禁用在线工具
2. `lahm/agents/utils/agent_utils.py` - 美股数据源优先级
3. `lahm/agents/utils/google_tool_handler.py` - 工具调用处理改进
