...
# 测试 MongoDB 连接
mongo --host localhost --port 27017 -u admin -p lahm123
```
...
1. `lahm/agents/analysts/market_analyst.py`
2. `lahm/agents/analysts/fundamentals_analyst.py`
3. `lahm/agents/analysts/china_market_analyst.py`
4. `lahm/agents/analysts/social_media_analyst.py`
...
# 检查环境变量
docker exec lahm-backend env | grep MONGODB
...
- `lahm/dataflows/interface.py` - 统一数据接口
- `lahm/dataflows/data_source_manager.py` - 数据源管理器
- `lahm/dataflows/cache/app_adapter.py` - MongoDB 缓存适配器
