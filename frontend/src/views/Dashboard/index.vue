  ...
  <div class="dashboard">
    ...
    <div class="welcome-section">
      ...
      <div class="welcome-actions">
        <el-button type="primary" size="large" @click="goToFactors">
      ...
      <el-col :span="16">
        <el-card class="quick-actions-card" header="快速操作">
          <div class="quick-actions">
            <div class="action-item" @click="goToFactors">
              <div class="action-icon">
                <el-icon><DataLine /></el-icon>
              </div>
              <div class="action-content">
                <h3>因子列表</h3>
                <p>查看国家队、暴跌抄底等因子信号与回测</p>
              </div>
              <el-icon class="action-arrow"><ArrowRight /></el-icon>
            </div>

            <div class="action-item" @click="goToLeads">
              <div class="action-icon">
                <el-icon><Flag /></el-icon>
              </div>
              <div class="action-content">
            ...
            <div class="action-item" @click="goToInvestments">
              <div class="action-icon">
