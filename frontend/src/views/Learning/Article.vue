...
const registry: Record<string, ArticleInfo> = {
  ...
  'lahm-intro': { title: '柳暗花明项目介绍', loader: () => import('../../../../docs/learning/06-resources/lahm-intro.md?raw'), category: '源项目与论文', categoryType: 'primary', readTime: '15分钟' },
  'paper-guide': { title: '柳暗花明论文解读', loader: () => import('../../../../docs/learning/06-resources/paper-guide.md?raw'), category: '源项目与论文', categoryType: 'primary', readTime: '20分钟' },
  'Lahm_论文中文版': { title: '柳暗花明 论文中文版', loader: () => import('../../../../docs/paper/Lahm_论文中文版.md?raw'), category: '源项目与论文', categoryType: 'primary', readTime: '40分钟' },
