  ...
  'resources': [
    {
      id: 'lahm-intro',
      title: '柳暗花明项目介绍',
      description: '了解柳暗花明的源项目柳暗花明的架构和特性',
      readTime: '15分钟',
      views: 1432,
      difficulty: 'warning',
      difficultyText: '进阶'
    },
    {
      id: 'paper-guide',
      title: '柳暗花明论文解读',
      description: '深度解读柳暗花明学术论文的核心内容和创新点',
      readTime: '20分钟',
      views: 987,
      difficulty: 'danger',
      difficultyText: '高级'
  ...
  'tutorials': [
    {
      id: 'getting-started',
      title: '快速入门教程',
      description: '从零开始学习如何使用柳暗花明进行股票分析',
      readTime: '10分钟',
      views: 3456,
      difficulty: 'success',
      difficultyText: '入门'
    },
    {
      ...
      title: '使用指南（试用版）',
      description: '柳暗花明 v1.0.1 使用指南与试用说明',
      readTime: '15分钟',
      views: 1288,
      difficulty: 'success',
      difficultyText: '入门'
