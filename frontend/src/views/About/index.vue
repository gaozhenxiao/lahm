      ...
      <div class="origin-content">
        <div class="origin-card">
          ...
          <div class="origin-description">
            <p>
              <strong>柳暗花明</strong> 是基于 <strong>TradingAgents</strong> 项目开发的中文本地化版本。
            ...
            <ul class="origin-improvements">
              ...
              <li>
                <el-icon class="check-icon"><CircleCheck /></el-icon>
                <span><strong>多LLM支持：</strong>支持国内外主流大语言模型（OpenAI、Claude、智谱AI、DeepSeek等）,推荐使用火山方舟聚合平台统一接入</span>
              </li>
              <li>
                <el-icon class="check-icon"><CircleCheck /></el-icon>
