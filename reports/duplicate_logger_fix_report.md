...
### lahm\agents\utils\agent_utils.py
...
### lahm\config\mongodb_storage.py
...
### lahm\dataflows\cache_manager.py

- 原有logger定义数: 2
  - 第18行: `logger = get_logger('agents')`
  - 第97行: `logger = get_logger('agents')`

### lahm\dataflows\data_source_manager.py
...
### lahm\dataflows\db_cache_manager.py

- 原有logger定义数: 2
  - 第17行: `logger = get_logger('agents')`
  - 第200行: `logger = get_logger('agents')`

### lahm\dataflows\finnhub_utils.py
...
### lahm\dataflows\hk_stock_utils.py

- 原有logger定义数: 2
  - 第15行: `logger = get_logger('agents')`
  - 第17行: `logger = get_logger('agents')`

### lahm\dataflows\interface.py

- 原有logger定义数: 2
  - 第13行: `logger = get_logger('agents')`
  - 第1594行: `logger = get_logger('agents')`

### lahm\dataflows\optimized_china_data.py

- 原有logger定义数: 2
  - 第17行: `logger = get_logger('agents')`
  - 第549行: `logger = get_logger('agents')`

### lahm\dataflows\optimized_us_data.py
...
### lahm\dataflows\stock_api.py

- 原有logger定义数: 2
  - 第13行: `logger = get_logger('agents')`
  - 第93行: `logger = get_logger('agents')`

### lahm\dataflows\stock_data_service.py

- 原有logger定义数: 2
  - 第15行: `logger = get_logger('agents')`
  - 第272行: `logger = get_logger('agents')`

### lahm\dataflows\tdx_utils.py

- 原有logger定义数: 2
  - 第15行: `logger = get_logger('agents')`
  - 第852行: `logger = get_logger('agents')`

### lahm\dataflows\tushare_utils.py
...
### lahm\dataflows\utils.py

- 原有logger定义数: 2
  - 第9行: `logger = get_logger('agents')`
  - 第11行: `logger = get_logger('agents')`

### lahm\dataflows\yfin_utils.py

- 原有logger定义数: 2
  - 第13行: `logger = get_logger('agents')`
  - 第19行: `logger = get_logger('agents')`

### lahm\dataflows\__init__.py

- 原有logger定义数: 2
  - 第8行: `logger = get_logger('agents')`
  - 第29行: `logger = get_logger('agents')`

### lahm\graph\trading_graph.py
...
### lahm\llm_adapters\dashscope_adapter.py

- 原有logger定义数: 2
  - 第22行: `logger = get_logger('agents')`
  - 第24行: `logger = get_logger('agents')`

### lahm\llm_adapters\dashscope_openai_adapter.py

- 原有logger定义数: 2
  - 第17行: `logger = get_logger('agents')`
  - 第228行: `logger = get_logger('agents')`

### lahm\utils\logging_init.py

- 原有logger定义数: 4
  - 第30行: `logger = get_logger('lahm.init')`
  - 第59行: `logger = get_logger(logger_name)`
  - 第92行: `logger = get_logger('lahm.startup')`
  - 第118行: `logger = get_logger('lahm.shutdown')`

### lahm\utils\logging_manager.py

- 原有logger定义数: 2
  - 第19行: `logger = get_logger('agents')`
  - 第21行: `logger = get_logger('agents')`

### upstream_contribution\batch1_caching\lahm\dataflows\cache_manager.py

- 原有logger定义数: 2
  - 第18行: `logger = get_logger('agents')`
  - 第97行: `logger = get_logger('agents')`

### upstream_contribution\batch1_caching\lahm\dataflows\optimized_us_data.py

- 原有logger定义数: 2
  - 第19行: `logger = get_logger('agents')`
  - 第240行: `logger = get_logger('agents')`

### upstream_contribution\batch2_error_handling\lahm\agents\analysts\fundamentals_analyst.py

- 原有logger定义数: 2
  - 第9行: `logger = get_logger('agents')`
  - 第258行: `logger = get_logger('agents')`

### upstream_contribution\batch2_error_handling\lahm\agents\analysts\market_analyst.py

- 原有logger定义数: 2
  - 第9行: `logger = get_logger('agents')`
  - 第212行: `logger = get_logger('agents')`

### upstream_contribution\batch2_error_handling\lahm\dataflows\db_cache_manager.py

- 原有logger定义数: 2
  - 第17行: `logger = get_logger('agents')`
  - 第200行: `logger = get_logger('agents')`

### upstream_contribution\batch3_data_sources\lahm\dataflows\optimized_us_data.py
