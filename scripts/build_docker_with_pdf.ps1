...
"@
    ...
    docker exec lahm-pdf-test python -c $weasyPrintCheck
    if ($LASTEXITCODE -ne 0) {
...
"@
    ...
    docker exec lahm-pdf-test python -c $pdfkitCheck
    if ($LASTEXITCODE -ne 0) {
    ...
    docker exec lahm-pdf-test pandoc --version
    if ($LASTEXITCODE -ne 0) {
    ...
    docker exec lahm-pdf-test wkhtmltopdf --version
    if ($LASTEXITCODE -ne 0) {
