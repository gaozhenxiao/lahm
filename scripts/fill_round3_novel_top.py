"""把 Round3 novel Top 候选写入 lahm（仅 INSERT）。

来源：data/factors/mine_csi300_500_1000_round3/{univ}/results.json
行情：腾讯 qfq（_shared/daily）；BaoStock 禁用。
硬性：不 update 已有 factor_id；不填空洞；撞号 abort。
注：#188 已被并行 IPO 实验占用 → 本脚本 MIN_UI=189。
"""
...
MINE_ROOT = ROOT / "data" / "factors" / "mine_csi300_500_1000_round3"
MIN_UI = 189
PROTECTED = (
...
CANDIDATES: List[Dict[str, Any]] = [
    {
        "factor_id": "ge_mid_m11_fmkv_d_h36_hs300_r3",
        "cfg_id": "ge_mid_r3__m11_fmkv_d_h36",
        "univ": "hs300",
    ...
    {
        "factor_id": "ge_fmkv_c_npmin5e8_hs300_r3",
        "cfg_id": "ge_r3__fmkv_c_npmin5e8",
        "univ": "hs300",
        "signal": sig.signal_gross_expand_break,
        "signal_name": "signal_gross_expand_break",
        "need_profit": True,
    ...
    {
        "factor_id": "ge_fmkv_d_soft_small_hs300_r3",
        "cfg_id": "ge_r3__fmkv_d_soft_small",
        "univ": "hs300",
        "signal": sig.signal_gross_expand_break,
        "signal_name": "signal_gross_expand_break",
        "need_profit": True,
    ...
    # struct_catchup_gp28_lag26_csi500_r3 已删除（原 UI#192；Mongo 占位 _gen_pad_ui192）
    {
        "factor_id": "struct_demand_pull_m16_csi500_r3",
        "cfg_id": "struct_r3__demand_pull_m16",
        "univ": "csi500",
    ...
    {
        "factor_id": "ge_mid_m12_brk85_h40_yoy10_csi500_r3",
        "cfg_id": "ge_mid_r3__m12_brk85_h40_yoy10",
        "univ": "csi500",
        "signal": sig.signal_gross_expand_break,
        "signal_name": "signal_gross_expand_break",
        "need_profit": True,
    ...
    {
        "factor_id": "q_np_exp150_h32_tp35_csi1000_r3",
        "cfg_id": "q_np_r3__exp150_h32_tp35",
        "univ": "csi1000",
    ...
    {
        "factor_id": "struct_gross_np_up_m16_csi1000_r3",
        "cfg_id": "struct_r3__gross_np_up_m16",
        "univ": "csi1000",
        "signal": sig.signal_gross_np_up_break,
        "signal_name": "signal_gross_np_up_break",
        "need_profit": True,
        "need_growth": False,
        "need_balance": False,
        "need_fin_db": False,
...
def _desc(c: dict, params: dict, mine: dict) -> str:
    return (
        f"mine_csi300_500_1000_round3 / {c['univ']} `{c['cfg_id']}`"
        f"（时间加权 tw≈{mine.get('tw_score'):.3f}；mine R3 时间加权）。"
    ...
    for dbn, planned in plans.items():
        ...
        for fid, created_at, ui in planned:
            ...
            payload = {
                ...
                "mine_meta": {
                    "source": f"mine_csi300_500_1000_round3/{c['univ']}",
                    "cfg_id": c["cfg_id"],
...
def main() -> None:
    ...
    out = ROOT / "data" / "factors" / "fill_round3_novel_top.json"
    payload = {
