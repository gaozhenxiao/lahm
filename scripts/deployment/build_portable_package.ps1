...
Write-Host "  Build 柳暗花明 Portable Package" -ForegroundColor Cyan
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($SkipPackage) {
    ...
    Write-Host "  1. Test the changes in release\Lahm-portable" -ForegroundColor Gray
...
$packageName = "Lahm-Portable-$Version-$timestamp"
...
$tempDir = Join-Path $env:TEMP "Lahm-Package-$timestamp"
