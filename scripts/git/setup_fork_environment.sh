...
# 配置变量
UPSTREAM_REPO="https://github.com/TauricResearch/柳暗花明.git"
FORK_REPO="https://github.com/hsliuping/柳暗花明.git"
LOCAL_DIR="柳暗花明-Fork"
LAHM_CN_DIR="../Lahm"  # 假设柳暗花明在上级目录
...
echo -e "${BLUE}🚀 设置柳暗花明 Fork开发环境${NC}"
echo "=================================="
