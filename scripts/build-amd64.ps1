# 柳暗花明 AMD64 (x86_64) 架构 Docker 镜像构建脚本 (PowerShell)
...
Write-Host "柳暗花明 AMD64 镜像构建" -ForegroundColor Blue
Write-Host "========================================" -ForegroundColor Blue
Write-Host ""
...
$BuilderName = "lahm-builder-amd64"
...
Write-Host "   docker images | Select-String lahm"
Write-Host ""
