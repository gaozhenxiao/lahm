# 柳暗花明 目录初始化脚本 (PowerShell版本)
# 创建Docker容器需要的本地目录结构

Write-Host "🚀 柳暗花明 目录初始化" -ForegroundColor Green
...
Write-Host "3. 实时查看日志: Get-Content logs\lahm.log -Wait" -ForegroundColor Gray
Write-Host ""
...
Write-Host "   Get-Content logs\lahm.log -Tail 50" -ForegroundColor Gray
Write-Host "   Get-Content logs\lahm.log -Wait" -ForegroundColor Gray
