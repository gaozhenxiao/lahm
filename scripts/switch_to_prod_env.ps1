...
Write-Host "  - lahm_mongodb_data" -ForegroundColor White
Write-Host "  - lahm_redis_data" -ForegroundColor White
Write-Host ""
...
Write-Host "  docker logs -f lahm-backend" -ForegroundColor Gray
Write-Host ""
