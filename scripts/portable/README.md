# 柳暗花明 Portable Scripts

This directory contains scripts for the 柳暗花明 portable (green) version.
...
```powershell
# Copy stop scripts
Copy-Item scripts/portable/stop_all.ps1 release/Lahm-portable/stop_all.ps1
Copy-Item scripts/portable/stop_all_services.bat release/Lahm-portable/停止所有服务.bat

# Copy documentation
Copy-Item docs/deployment/stop-services-guide.md release/Lahm-portable/停止服务说明.md
```
...
- [start_portable.ps1](../../release/Lahm-portable/start_portable.ps1) - Portable version startup script
