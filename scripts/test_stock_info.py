...
def test_stock_info_retrieval():
    ...
    for code in test_codes:
        ...
        try:
            ...
            from lahm.dataflows.interface import get_china_stock_info_tushare
            ...
            from lahm.dataflows.data_source_manager import get_china_stock_info_unified as manager_info
            manager_result = manager_info(code)
            print(f"✅ Manager结果: {manager_result}")
            
            # 4. 测试TushareAdapter直接调用
            print(f"🔍 步骤4: 测试TushareAdapter...")
            from lahm.dataflows.tushare_adapter import get_tushare_adapter
