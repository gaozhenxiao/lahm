...
def setup_docker_env():
    ...
    logger.info(f"🐳 柳暗花明 Docker环境配置向导")
    logger.info(f"=")
    ...
    logger.info(f"- LAHM_DEEPSEEK_API_KEY")
    logger.info(f"- LAHM_DASHSCOPE_API_KEY")
    logger.info(f"- LAHM_TUSHARE_TOKEN")
    logger.info(f"- LAHM_FINNHUB_API_KEY")
