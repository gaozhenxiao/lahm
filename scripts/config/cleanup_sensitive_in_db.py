...
使用方法（PowerShell 示例）：
  .\.venv\Scripts\python scripts\config\cleanup_sensitive_in_db.py --mongo "mongodb://localhost:27017/lahm" --apply
或仅查看（dry-run）：
  .\.venv\Scripts\python scripts\config\cleanup_sensitive_in_db.py --mongo "mongodb://localhost:27017/lahm"
"""
...
def main():
    ...
    parser.add_argument("--mongo", required=False, default=os.getenv("MONGO_URI", "mongodb://localhost:27017/lahm"))
