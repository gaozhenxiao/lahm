...
[logging.development]
enabled = false
debug_modules = ["lahm.graph", "lahm.llm_adapters"]
...
def main():
    ...
    print("3. 简单测试: docker exec 柳暗花明-web python simple_log_test.py")
    print("4. 检查日志: ls -la logs/")
    print("5. 查看容器日志: docker-compose logs web")
    
    print("\n🔧 如果还有问题:")
    print("- 检查容器启动日志: docker-compose logs web")
    print("- 进入容器调试: docker exec -it 柳暗花明-web bash")
    print("- 检查配置文件: docker exec 柳暗花明-web cat /app/config/logging_docker.toml")
