...
# 配置
PROJECT_NAME="柳暗花明-Demo"
GITHUB_REPO="https://github.com/your-org/柳暗花明"
GITHUB_RAW="https://raw.githubusercontent.com/your-org/柳暗花明/main"
...
configure_env() {
    ...
    sed -i "s|MONGO_URI=.*|MONGO_URI=mongodb://admin:$MONGO_PASSWORD@mongodb:27017/lahm?authSource=admin|" .env
...
show_info() {
    ...
    echo ""
    echo -e "${BLUE}文档:${NC}"
    echo -e "  完整文档: ${GREEN}https://github.com/your-org/柳暗花明/blob/main/docs/deploy_demo_system.md${NC}"
    echo ""
}
