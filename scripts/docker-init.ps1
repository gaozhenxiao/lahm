# Docker环境初始化脚本 - 柳暗花明 v1.0.0-preview (PowerShell)

$ErrorActionPreference = "Stop"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "柳暗花明 Docker 初始化" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "初始化数据库..."
docker-compose exec -T mongodb mongo lahm /docker-entrypoint-initdb.d/mongo-init.js
