...
Write-Host "  - lahm-mongodb-test" -ForegroundColor White
Write-Host "  - lahm-redis-test" -ForegroundColor White
Write-Host "  - lahm-backend-test" -ForegroundColor White
Write-Host "  - lahm-frontend-test" -ForegroundColor White
Write-Host ""
...
Write-Host "  docker logs -f lahm-backend-test" -ForegroundColor Gray
Write-Host ""
