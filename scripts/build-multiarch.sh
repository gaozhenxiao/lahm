...
# 镜像名称
BACKEND_IMAGE="lahm-backend"
FRONTEND_IMAGE="lahm-frontend"

# 支持的架构（可通过环境变量覆盖）
PLATFORMS="${PLATFORMS:-linux/amd64,linux/arm64}"

echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}柳暗花明 多架构镜像构建${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "   docker buildx build --platform linux/arm64 -f Dockerfile.backend -t lahm-backend:arm64 ."
echo ""
