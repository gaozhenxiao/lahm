...
# 镜像名称（ARM64 独立仓库）
BACKEND_IMAGE="lahm-backend-arm64"
FRONTEND_IMAGE="lahm-frontend-arm64"

# 目标架构
PLATFORM="linux/arm64"

echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}柳暗花明 ARM64 镜像构建${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
BUILDER_NAME="lahm-builder-arm64"
...
if [ -n "$REGISTRY" ]; then
    ...
    echo -e "  - AMD64 版本使用独立仓库: ${REGISTRY}/lahm-backend-amd64"
    echo -e "  - 可以独立更新，互不影响"
else
