...
Write-Host "  - Test containers (lahm-*-test)" -ForegroundColor White
Write-Host "  - Test data volumes (lahm_test_*)" -ForegroundColor White
...
docker volume ls --format "table {{.Name}}\t{{.Driver}}" | Select-String "lahm"
Write-Host ""
