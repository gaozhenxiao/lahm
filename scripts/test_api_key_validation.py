...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("sk-test00000000000000000000000000000001", True, "有效的 API Key"),
        ("sk-test00000000000000000000000000000002", True, "有效的 API Key"),
        ("AIzaSyTestOnlyFakeGoogleKey000000000001", True, "有效的 Google API Key"),
        ("bce-v3/ALTAK-TESTONLYFAKEKEY000001/testonlyfakekey000000000000000000000001", True, "有效的千帆 API Key"),
        ("sk-or-v1-testonlyfakeopenrouterkey000000000000000000000000000000000001", True, "有效的 OpenRouter API Key"),
        ('"sk-test00000000000000000000000000000001"', True, "带引号的有效 API Key"),
        ("'sk-test00000000000000000000000000000001'", True, "带单引号的有效 API Key"),
    ]
