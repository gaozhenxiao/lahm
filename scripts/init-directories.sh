...
level = "ERROR"
formatter = "detailed"
filename = "/app/logs/lahm_error.log"
...
此目录用于存储 柳暗花明 应用的日志文件。

## 日志文件说明

- `lahm.log` - 主应用日志文件
- `lahm_error.log` - 错误日志文件
- `lahm.log.1`, `lahm.log.2` 等 - 轮转的历史日志文件
...
echo "3. 实时查看日志: tail -f logs/lahm.log"
echo ""
echo "📁 重要目录说明:"
echo "   logs/     - 应用日志文件"
echo "   data/     - 数据缓存和导出文件"
