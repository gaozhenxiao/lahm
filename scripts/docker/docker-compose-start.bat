@echo off
REM 柳暗花明 Docker Compose启动脚本
REM 使用Docker Compose管理所有服务

echo ========================================
echo 柳暗花明 Docker Compose启动脚本
echo ========================================
...
echo 🔍 等待健康检查完成...
:healthcheck_loop
docker-compose ps --filter "health=healthy" | findstr "lahm" >nul
if %errorlevel% neq 0 (
    echo ⏳ 等待服务健康检查...
...
echo ========================================
echo 🗄️ MongoDB:
echo    - 连接地址: mongodb://admin:lahm123@localhost:27017/lahm
echo    - 端口: 27017
echo    - 用户名: admin
echo    - 密码: lahm123
echo.
