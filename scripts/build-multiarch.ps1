# 柳暗花明 多架构 Docker 镜像构建脚本 (PowerShell)
...
# 镜像名称
$BackendImage = "lahm-backend"
$FrontendImage = "lahm-frontend"

Write-Host "========================================" -ForegroundColor Blue
Write-Host "柳暗花明 多架构镜像构建" -ForegroundColor Blue
Write-Host "========================================" -ForegroundColor Blue
Write-Host ""
...
Write-Host "   docker buildx build --platform linux/arm64 -f Dockerfile.backend -t lahm-backend:arm64 ."
Write-Host ""
