...
# 配置
$BackendImageLocal = "lahm-backend:$Version"
$FrontendImageLocal = "lahm-frontend:$Version"
$BackendImageRemote = "$DockerHubUsername/lahm-backend"
$FrontendImageRemote = "$DockerHubUsername/lahm-frontend"
