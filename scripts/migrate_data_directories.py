...
class DataDirectoryMigrator:
    ...
    def __init__(self, project_root: str = None):
        ...
        self.migration_map = [
            # 缓存数据迁移
            ('lahm/dataflows/data_cache', 'data/cache'),
    ...
    def create_backup(self) -> bool:
        ...
        try:
            ...
            # 备份现有数据目录
            backup_paths = ['data', 'web/data', 'results', 'lahm/dataflows/data_cache']
...
# 子目录配置（可选，使用默认值）
LAHM_CACHE_DIR=${LAHM_DATA_DIR}/cache
LAHM_SESSIONS_DIR=${LAHM_DATA_DIR}/sessions
LAHM_LOGS_DIR=${LAHM_DATA_DIR}/logs
LAHM_CONFIG_DIR=${LAHM_DATA_DIR}/config
LAHM_TEMP_DIR=${LAHM_DATA_DIR}/temp

# 更新结果目录配置
LAHM_RESULTS_DIR=${LAHM_DATA_DIR}/analysis_results
"""
            
            # 如果还没有这些配置，则添加
            if 'LAHM_DATA_DIR' not in content:
                content += new_config
