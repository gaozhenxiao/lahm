...
class AuthManager:
    ...
    def _inject_auth_cache_js(self):
        ...
        window.AuthCache = {
            ...
            saveAuth: function(userInfo) {
                ...
                localStorage.setItem('lahm_auth', JSON.stringify(authData));
            ...
            getAuth: function() {
                try {
                    const authData = localStorage.getItem('lahm_auth');
                    ...
                    localStorage.setItem('lahm_auth', JSON.stringify(data));
            ...
            // 清除登录状态
            clearAuth: function() {
                localStorage.removeItem('lahm_auth');
                console.log('🧹 登录状态已清除');
            },
    ...
    def logout(self):
        ...
        try {
            localStorage.removeItem('lahm_auth');
            localStorage.removeItem('lahm_last_activity');
            console.log('✅ 认证数据已清除');
        } catch (e) {
