...
def test_akshare_hk_availability():
    ...
    try:
        from lahm.dataflows.interface import AKSHARE_HK_AVAILABLE, HK_STOCK_AVAILABLE
        ...
        if AKSHARE_HK_AVAILABLE:
            ...
            # 测试AKShare港股函数
            from lahm.dataflows.akshare_utils import get_hk_stock_data_akshare
...
def test_market_analyst_modification():
    ...
    try:
        # 读取市场分析师文件内容
        with open('lahm/agents/analysts/market_analyst.py', 'r', encoding='utf-8') as f:
            content = f.read()
