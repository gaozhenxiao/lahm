...
from lahm.dataflows.providers.tushare_provider import TushareProvider
...
class TestTushareProvider:
    ...
    async def test_connect_success(self, provider, mock_tushare_api):
        """测试连接成功"""
        with patch('lahm.dataflows.providers.tushare_provider.TUSHARE_AVAILABLE', True), \
             patch('lahm.dataflows.providers.tushare_provider.ts') as mock_ts, \
