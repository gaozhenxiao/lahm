...
def test_reddit_tools():
    ...
    try:
        ...
        from lahm.dataflows.interface import get_reddit_global_news, get_reddit_company_news
        
        print("✅ Reddit工具函数导入成功")
        
        # 检查Reddit数据目录
        reddit_data_dir = Path("lahm/dataflows/data_cache/reddit_data")
...
def test_toolkit_integration():
    ...
    try:
        ...
        # 检查Toolkit类是否包含这些工具
        from lahm.agents.utils.toolkit import Toolkit
