...
try:
    from lahm.dataflows.stock_data_service import StockDataService, get_stock_data_service
...
class TestFallbackMechanism(unittest.TestCase):
    ...
    @patch('lahm.dataflows.stock_data_service.DATABASE_MANAGER_AVAILABLE', False)
