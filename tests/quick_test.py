...
# 测试缓存管理器
try:
    from lahm.dataflows.cache_manager import get_cache, StockDataCache
...
# 测试优化美股数据
try:
    from lahm.dataflows.optimized_us_data import get_optimized_us_data_provider
...
# 测试配置模块
try:
    from lahm.dataflows.config import get_config
    print("✅ config 导入成功")
