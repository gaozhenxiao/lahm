...
def test_basics_prefers_app_cache_when_enabled(monkeypatch):
    ...
    import lahm.dataflows.stock_data_service as sds_mod
    monkeypatch.setattr(sds_mod, "ENHANCED_FETCHER_AVAILABLE", True, raising=False)

    from lahm.dataflows.stock_data_service import StockDataService
...
def test_realtime_quotes_prefers_app_market_quotes(monkeypatch):
    ...
    import lahm.dataflows.app_cache_adapter as app_cache_adapter
    ...
    from lahm.dataflows.tushare_adapter import TushareDataAdapter
