...
from lahm.llm_clients.base_client import BaseLLMClient
from lahm.llm_clients.factory import create_llm_client
from lahm.llm_clients.model_catalog import get_known_models
from lahm.llm_clients.validators import validate_model
...
class ModelValidationTests(unittest.TestCase):
    ...
    def test_factory_supports_google_via_compatible_adapter(self):
        fake_google_adapter = ModuleType("lahm.llm_adapters.google_openai_adapter")
        ...
        with patch.dict("sys.modules", {"lahm.llm_adapters.google_openai_adapter": fake_google_adapter}):
