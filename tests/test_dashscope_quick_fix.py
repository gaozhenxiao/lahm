...
def test_vs_old_adapter():
    ...
    try:
        from lahm.llm_adapters import ChatDashScope, ChatDashScopeOpenAI
...
def test_import_completeness():
    ...
    imports = [
        ("ChatDashScopeOpenAI", "lahm.llm_adapters"),
        ("create_dashscope_openai_llm", "lahm.llm_adapters.dashscope_openai_adapter"),
        ("LahmGraph", "lahm.graph.trading_graph"),
        ("get_china_stock_data_unified", "lahm.dataflows")
    ]
