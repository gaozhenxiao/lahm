...
def test_fundamentals_analyst_prompt():
    ...
    try:
        ...
        from lahm.agents.utils.agent_utils import Toolkit
        ...
        # 创建基本面分析师
        from lahm.agents.analysts.fundamentals_analyst import create_fundamentals_analyst
        ...
        for ticker, market_type, expected_name in test_cases:
            ...
            # 获取公司名称（验证提示词构建逻辑）
            from lahm.agents.analysts.fundamentals_analyst import _get_company_name_for_fundamentals
...
def test_market_analyst_prompt():
    ...
    try:
        ...
        # 创建市场分析师
        from lahm.agents.analysts.market_analyst import create_market_analyst
        ...
        # 获取公司名称（验证提示词构建逻辑）
        from lahm.agents.analysts.market_analyst import _get_company_name
        from lahm.utils.stock_utils import StockUtils
