...
def test_improved_hk_provider_priority():
    ...
    try:
        from lahm.dataflows.providers.hk.improved_hk import get_improved_hk_provider
...
def test_data_source_availability():
    ...
    try:
        # 检查AKShare可用性
        try:
            from lahm.dataflows.akshare_utils import get_hk_stock_info_akshare
            print("✅ AKShare港股工具可用")
        ...
        # 检查Yahoo Finance可用性
        try:
            from lahm.dataflows.hk_stock_utils import get_hk_stock_info
        ...
        # 检查统一接口
        try:
            from lahm.dataflows.interface import get_hk_stock_info_unified, AKSHARE_HK_AVAILABLE, HK_STOCK_AVAILABLE
            print("✅ 统一港股接口可用")
