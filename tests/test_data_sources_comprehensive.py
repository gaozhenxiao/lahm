...
def test_china_stock_data_sources():
    ...
    for symbol in test_symbols:
        ...
        try:
            print(f"🔍 测试优化版本...")
            from lahm.dataflows.optimized_china_data import get_china_stock_data_cached
...
def test_us_stock_data_sources():
    ...
    for symbol in test_symbols:
        ...
        try:
            ...
            from lahm.dataflows.interface import get_YFin_data_online
...
def test_cache_system():
    ...
    try:
        print(f"🔍 测试缓存管理器...")
        from lahm.dataflows.cache_manager import get_cache
