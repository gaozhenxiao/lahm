...
from lahm.dataflows.config import get_data_dir, set_data_dir, initialize_config
...
def test_data_dir_configuration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # 设置环境变量
        os.environ["LAHM_DATA_DIR"] = env_data_dir
        print(f"设置环境变量 | Setting environment variable: LAHM_DATA_DIR={env_data_dir}")
