...
# 复用现有数据源提供者
from lahm.dataflows.providers.hk.hk_stock import HKStockProvider
...
class ForeignStockService:
    ...
    def _get_hk_quote_from_akshare(self, code: str) -> Dict:
        """从AKShare获取港股行情"""
        from lahm.dataflows.providers.hk.improved_hk import get_hk_stock_info_akshare
    ...
    def _get_us_quote_from_alpha_vantage(self, code: str) -> Dict:
        ...
        try:
            from lahm.dataflows.providers.us.alpha_vantage_common import get_api_key, _make_api_request
    ...
    def _get_hk_info_from_akshare(self, code: str) -> Dict:
        ...
        from lahm.dataflows.providers.hk.improved_hk import (
