...
from lahm.llm_clients.provider_keys import canonical_aliases, normalize_provider_key
    ...
    async def _create_default_config(self) -> SystemConfig:
        ...
        default_config = SystemConfig(
            ...
            system_settings={
                ...
                # 柳暗花明 runtime intervals (optional; DB-managed)
    ...
    def _test_openrouter_api(self, api_key: str, display_name: str) -> dict:
        ...
        try:
            ...
            headers = {
                "Content-Type": "application/json",
                "Authorization": f"Bearer {api_key}",
                "HTTP-Referer": "https://lahm.cn",  # OpenRouter要求
                "X-Title": "柳暗花明"
            }
