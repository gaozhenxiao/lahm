...
from lahm.utils.dataflow_utils import save_output, SavePathType, decorate_all_methods
...
def get_stock_data_with_indicators(
    ...
    参考原版 柳暗花明 的 get_YFin_data_online 实现
    """
    try:
        # 验证日期格式
...
def get_technical_indicator(
    ...
    参考原版 柳暗花明 的 get_stock_stats_indicators_window 实现
