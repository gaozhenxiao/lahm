...
class OptimizedUSDataProvider:
    ...
    def __init__(self):
        ...
        # 🔥 初始化数据源管理器（从数据库读取配置）
        try:
            from lahm.dataflows.data_source_manager import USDataSourceManager
    ...
    def get_stock_data(self, symbol: str, start_date: str, end_date: str,
        ...
        if not source_priority:
            ...
            from lahm.dataflows.data_source_manager import USDataSource
    ...
    def _format_stock_data(self, symbol: str, data: pd.DataFrame,
        ...
        from lahm.tools.analysis.indicators import add_all_indicators
...
"""
    ...
    def _get_data_from_alpha_vantage(self, symbol: str, start_date: str, end_date: str) -> str:
        ...
        try:
            from lahm.dataflows.providers.us.alpha_vantage_common import get_api_key
            import requests
