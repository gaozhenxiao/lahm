...
# 导入统一日志系统
from lahm.utils.logging_init import setup_dataflow_logging
logger = setup_dataflow_logging()

# 导入统一数据源编码
from lahm.constants import DataSourceCode
...
class ChinaDataSource(Enum):
    ...
    注意：这个枚举与 lahm.constants.DataSourceCode 保持同步
    值使用统一的数据源编码
    """
...
class DataSourceManager:
    ...
    def _identify_market_category(self, symbol: Optional[str]) -> Optional[str]:
        ...
        try:
            from lahm.utils.stock_utils import StockUtils, StockMarket
