...
import lahm.dataflows.interface as interface
from lahm.default_config import DEFAULT_CONFIG
from langchain_core.messages import HumanMessage

# 导入统一日志系统和工具日志装饰器
from lahm.utils.logging_init import get_logger
from lahm.utils.tool_logging import log_tool_call, log_analysis_step
...
class Toolkit:
    ...
    def get_china_stock_data(
        ...
        try:
            ...
            from lahm.dataflows.interface import get_china_stock_data_unified
    ...
    def get_china_market_overview(
        ...
        try:
            # 使用Tushare获取主要指数数据
            from lahm.dataflows.providers.china.tushare import get_tushare_adapter
...
"""
    ...
    def get_china_fundamentals(
        ...
        try:
            ...
            # 调用真正的基本面分析
            from lahm.dataflows.optimized_china_data import OptimizedChinaDataProvider
    ...
    def get_hk_stock_data_unified(
        ...
        try:
            from lahm.dataflows.interface import get_hk_stock_data_unified
        ...
        try:
            ...
            if is_china:
                ...
                if not hk_data_success:
                    try:
                        from lahm.dataflows.interface import get_hk_stock_info_unified
...
"""
                ...
                try:
                    from lahm.dataflows.interface import get_fundamentals_openai
    ...
    def get_stock_market_data_unified(
        ...
        try:
            ...
            if is_china:
                ...
                try:
                    from lahm.dataflows.providers.us.optimized import get_us_stock_data_cached
        ...
        try:
            ...
            if is_china or is_hk:
                ...
                try:
                    ...
                    from lahm.dataflows.interface import get_google_news
                ...
                try:
                    from lahm.dataflows.interface import get_finnhub_news
...
"""
                ...
                try:
                    from lahm.dataflows.interface import get_reddit_sentiment
